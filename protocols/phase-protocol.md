...
# 2. 如果不存在，创建目录
mkdir -p E:/web_tools/.agent/harness/
...
# 2. 读取 Analyzer Agent
read e:/Mytest_skill/.trae/skills/ReqPlan-v3/agents/analyzer-agent.md
...
ANALYZE 完成后进入，或 DESIGN/IMPLEMENT 遇到问题时返回。
...
2. 输出结束摘要
   ...
   产出文件：
   - E:/web_tools/.agent/harness/_analysis.md
